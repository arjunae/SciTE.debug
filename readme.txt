...
Codebug
	...
	Codebug uses Gunnar Zötls lua clib called dbghelper paired with Scott Lembke's debugger.lua 
    to debug lua scripts using (SciTE's) internal lua instance only with no other dependencies.